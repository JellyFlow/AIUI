...
- **Bluetooth**: Connect to and read from or write to BLE peripherals.
...
- **[Bluetooth](/AIUI/guide/basic-device-bluetooth)**: Learn how to connect to and exchange data with BLE peripherals.
