      ...
      },
      {
        ...
        "components": [
          ...
          },
          {
            ...
            "type": "view",
            "props": {
              "style": "width: 100%; height: 1px; background-color: var(--a2ui-divider-color, var(--border-color-default)); margin-bottom: 20px;"
            }
          },
          {
            "id": "info-list",
...
<style>
  .container {
    ...
    --a2ui-button-background: var(--border-color-success, #34c759);
    --a2ui-button-text-color: #ffffff;
    --a2ui-stream-button-background: var(--color-primary);
    display: flex;
  ...
  .btn {
    width: 100%;
    height: 44px;
    background-color: var(--a2ui-button-background);
    color: var(--a2ui-button-text-color);
    font-size: 16px;
    font-weight: bold;
    border-radius: 8px;
    display: flex;
  ...
  .stream-btn {
    background-color: var(--a2ui-stream-button-background);
  }
